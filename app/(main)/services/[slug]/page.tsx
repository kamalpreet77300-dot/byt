...
const SERVICE_DETAILS: Record<string, any> = {
    'web-development': {
        ...
        process: [
            { step: 'Requirements', desc: 'Understanding your business goals and detailed requirements gathering.' },
            { step: 'UI/UX Design', desc: 'Creating wireframes and high-fidelity prototypes for approval.' },
            { step: 'Architecture', desc: 'Planning scalable technical architecture and database schemas.' },
            { step: 'Frontend Dev', desc: 'Building responsive user interfaces with React and Tailwind.' },
            { step: 'Backend APIs', desc: 'Developing robust server-side logic and secure API endpoints.' },
            { step: 'SEO & Speed', desc: 'Optimizing for search engines and lightning-fast performance.' },
            { step: 'Rigorous Testing', desc: 'End-to-end testing across devices and browser environments.' },
            { step: 'Deployment', desc: 'Launching to production with automated CI/CD pipelines.' },
        ],
        features: [
    ...
    'mobile-app-development': {
        ...
        process: [
            { step: 'Analysis', desc: 'Deep-dive into app requirements and target audience.' },
            { step: 'Platform Selection', desc: 'Choosing between Flutter, React Native, or Native apps.' },
            { step: 'Mobile Design', desc: 'Creating mobile-first UI/UX for touch interactions.' },
            { step: 'Development', desc: 'Coding the app core and cross-platform components.' },
            { step: 'Integration', desc: 'Integrating APIs, sensors, and device-specific features.' },
            { step: 'Testing', desc: 'Rigorous testing on physical iOS and Android devices.' },
            { step: 'Store Launch', desc: 'Handling submission to App Store and Google Play.' },
            { step: 'Optimization', desc: 'Post-launch performance monitoring and updates.' },
        ],
        features: [
    ...
    'ai-ml-solutions': {
        ...
        process: [
            { step: 'Data Analysis', desc: 'Exploring raw datasets for patterns and quality.' },
            { step: 'Preprocessing', desc: 'Cleaning and preparing data for model training.' },
            { step: 'Model Selection', desc: 'Choosing the right algorithms for your specific use-case.' },
            { step: 'Training', desc: 'Training models on high-performance compute clusters.' },
            { step: 'Optimization', desc: 'Fine-tuning hyperparameters for maximum accuracy.' },
            { step: 'Integration', desc: 'Wrapping models in accessible APIs and interfaces.' },
            { step: 'Intelligence', desc: 'Enabling real-time predictive and generative power.' },
            { step: 'Monitoring', desc: 'Continuous feedback loops for model evolution.' },
        ],
        features: [
    ...
    'saas-development': {
        ...
        process: [
            { step: 'Architecture', desc: 'Designing multi-tenant backend architecture.' },
            { step: 'Tenancy Setup', desc: 'Handling secure data isolation for global users.' },
            { step: 'Auth & Billing', desc: 'Setting up subscriptions and RBAC systems.' },
            { step: 'Dashboards', desc: 'Building comprehensive admin and user panels.' },
            { step: 'Backend Services', desc: 'Scalable server-side logic and background jobs.' },
            { step: 'Cloud Launch', desc: 'Deploying to cloud with Docker and Kubernetes.' },
            { step: 'Scaling', desc: 'Horizontal scaling to handle millions of users.' },
            { step: 'Evolution', desc: 'Regular updates and feature releases.' },
        ],
        features: [
    ...
    'api-backend-development': {
        ...
        process: [
            { step: 'API Design', desc: 'Creating standardized REST or GraphQL contracts.' },
            { step: 'DB Modeling', desc: 'Designing optimized relational or NoSQL schemas.' },
            { step: 'Auth & RBAC', desc: 'Implementing JWT, OAuth, and granular permissions.' },
            { step: 'Performance', desc: 'Query optimization and Redis caching layers.' },
            { step: 'Security', desc: 'Hardening against XSS, SQLi, and brute force.' },
            { step: 'Documentation', desc: 'Generating interactive Swagger/OpenAPI docs.' },
            { step: 'Integrations', desc: 'Connecting to third-party services and frontends.' },
            { step: 'Maintenance', desc: 'Monitoring, logging, and performance tuning.' },
        ],
        features: [
    ...
    'cloud-devops': {
        ...
        process: [
            { step: 'Architecture', desc: 'Designing resilient cloud infrastructure on AWS/Azure.' },
            { step: 'Containers', desc: 'Dockerizing applications for consistency across envs.' },
            { step: 'CI/CD Setup', desc: 'Automating build, test, and deployment flows.' },
            { step: 'Automation', desc: 'Infrastructure as Code with Terraform or Ansible.' },
            { step: 'Deployment', desc: 'Blue-green or canary deployments for zero downtime.' },
            { step: 'Monitoring', desc: 'Setting up ELK stack, Prometheus, and Grafana.' },
            { step: 'Security', desc: 'Network hardening, IAM, and secret management.' },
            { step: 'Scaling', desc: 'Auto-scaling and load balancing for high traffic.' },
        ],
        features: [
